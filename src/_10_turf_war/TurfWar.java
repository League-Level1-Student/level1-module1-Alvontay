...
public class TurfWar extends PApplet {
    ...
    public void setup() {
        ...
        player1 = new Player(100, 100, 10, 20, Color.red.getRGB(), UP, LEFT, DOWN, RIGHT);
        player2 = new Player(400, 100, 10, 20, Color.blue.getRGB(), W, A, S, D);
        
        //int x, int y, int speed, int playerSize, int playerColor, int upKey, int leftKey, int downKey, int rightKey

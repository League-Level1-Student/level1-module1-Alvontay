...
//It has a secret code that will be randomly chosen each time the program is run.
//It also contains a tryCode() method that takes a number as a parameter and returns 
